...
import de.cit.backend.agent.auth.Authentication;
import de.cit.backend.agent.auth.HttpBasicAuth;
import de.cit.backend.agent.auth.ApiKeyAuth;
import de.cit.backend.agent.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://tba/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://tba/v2
