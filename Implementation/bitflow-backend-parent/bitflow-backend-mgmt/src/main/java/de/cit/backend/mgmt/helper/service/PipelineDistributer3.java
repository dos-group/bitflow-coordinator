 ...
 *
 */
public class PipelineDistributer3 {

	
	private static final Logger log = Logger.getLogger(PipelineDistributer3.class);
	...
	public PipelineDistributer3() throws BitflowException{
		this(-1);
	}
	
	public PipelineDistributer3(int maxNumberOfAgents) throws BitflowException{
		agentNumber = 0;
		increment = 1;
