...
public class ProjectApiServiceImpl extends ProjectApiService {
	...
	@Override
	public Response projectIdPipelineDelete(Integer id, SecurityContext securityContext) throws NotFoundException {
		// do some magic!
		return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
	}

	@Override
	public Response projectIdPipelineGet(Integer id, SecurityContext securityContext) throws NotFoundException {
		// do some magic!
		User user = new User();
		user.setEmail("cit@est.de");
		user.setID(1);
